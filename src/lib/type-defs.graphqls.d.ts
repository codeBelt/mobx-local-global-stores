/* 2262889def74572570cedb4b1f40d284613a8b93
...
export declare type UserNameResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserName'] = ResolversParentTypes['UserName']> = {
